        ...
        if (event.target.id === 'T1') {
            setTimeout(() => {
                const t1AddAssetUnity = [
                    {'title': "Add Asset In Unity", 'subtitleone': "Drag and drop", 'describeone': "From folder to Window", 'subtitletwo': "Blender to Unity", 'describetwo': "Settings Before Export: FBX - Selected Object, Mesh,", 'describethree': "Apply Transform, Apply Modifiers, Save Preset(Top)<br><br>", 'image': "/images/AddAssetFull.gif"},
                ]
                       ...
                       <aside class="right-info">
                         ...
                         <div>
                            <figure class="image is-5by3 is-skeleton">
                              <img class="all-photos" alt="Placeholder" src="${category.image}">
                            </figure>
                         </div>
                       </aside>
                    </section>
            ...
            setTimeout(() => {
                const t2AddAssetImport = [
                    {'title': "Add Asset Import", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                ]
...
function createInformation() {
    ...
    function switchInformation(event) {
        if (event.target.id === 'add-asset-unity') {   //1
                       ...
                       <aside class="right-info">
                         ...
                         <div>
                            <div class="${category.classbackground}">
                              <div class= "code-help skeleton-block">
                                ${category.code}
                              </div>
                            </div>
                         </div>
            ...
            setTimeout(() => {
                const t3AddAssetSpawning = [
                    {'title': "Destroy Method", 'subtitleone': "Destroy", 'describeone': "Spawn at location and create prefabs to spawn", 'subtitletwo': "Code Explained", 'describetwo': "", 'describethree': "", 'classbackground': "code-background", 'code': "public GameObject objectToDestroy;<br>&nbsp<br>public void DestroyObject()<br>{<br>&nbsp&nbsp&nbsp&nbspDestroy(objectToDestroy);<br>}<br><br>", 'image': ""},
                    {'title': "Destroy with Delay", 'subtitleone': "Create a Scenes Folder In Main Assets Folder", 'describeone': "Go to File(top) then New Scene<br>Choose between Empty or (Basic)", 'subtitletwo': "Save Scene To Game File > Build Settings", 'describetwo': "Add Scenes to scenes in build in order", 'describethree': "Choose Build when game is complete<br><br>*Can locate all scenes in the Scenes Folder", 'classbackground': "code-background", 'code': "public GameObject objectToDestroy;<br>public float delay = 2f;<br>&nbsp<br>public void DestroyObjectWithDelay()<br>{<br>&nbsp&nbsp&nbsp&nbspDestroy(objectToDestroy, delay);<br>}<br><br>", 'image': ""},
                    {'title': "Destroy by Tag or Name", 'subtitleone': "Create a Scenes Folder In Main Assets Folder", 'describeone': "Go to File(top) then New Scene<br>Choose between Empty or (Basic)", 'subtitletwo': "Save Scene To Game File > Build Settings", 'describetwo': "Add Scenes to scenes in build in order", 'describethree': "Choose Build when game is complete<br><br>*Can locate all scenes in the Scenes Folder", 'classbackground': "code-background", 'code': "public string tagToDestroy = 'Enemy';<br>&nbsp<br>public void DestroyObjectsByTag()<br>{<br>&nbsp&nbsp&nbsp&nbspGameObject[] objectsToDestroy = GameObject.FindGameObjectsWithTag(tagToDestroy);<br>&nbsp&nbsp&nbsp&nbspforeach (GameObject obj in objectsToDestroy)<br>&nbsp&nbsp&nbsp&nbsp{<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDestroy(obj);<br>&nbsp&nbsp&nbsp&nbsp}<br>}<br><br>", 'image': ""},
                    {'title': "Destroy by Collision", 'subtitleone': "Create a Scenes Folder In Main Assets Folder", 'describeone': "Go to File(top) then New Scene<br>Choose between Empty or (Basic)", 'subtitletwo': "Save Scene To Game File > Build Settings", 'describetwo': "Add Scenes to scenes in build in order", 'describethree': "Choose Build when game is complete<br><br>*Can locate all scenes in the Scenes Folder", 'classbackground': "code-background", 'code': "void OnCollisionEnter(Collision collision)<br>{<br>&nbsp&nbsp&nbsp&nbspif (collision.gameObject.CompareTag('Projectile'))<br>&nbsp&nbsp&nbsp&nbsp{<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDestroy(gameObject);<br>&nbsp&nbsp&nbsp&nbsp}<br>}<br><br>", 'image': ""},
                ]
...
function createInformationRight() {
    ...
    function switchRightInformation(event) {
        if (event.target.id === 'levels') {
            ...
            setTimeout(() => {
                const tFolderTypes = [
                    {'title': "Scenes (.unity)", 'subtitleone': "Scene files", 'describeone': "represent different<br> - levels<br>- menus<br>-other sections of your game", 'subtitletwo': "", 'describetwo': "", 'describethree': "<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Scripts (.cs, .js, .boo)", 'subtitleone': "Script files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Prefabs (.prefab)", 'subtitleone': "Prefab files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Textures (.png, .jpg, .tga)", 'subtitleone': "Image files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Materials (.mat)", 'subtitleone': "Material files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Models (.fbx, .obj)", 'subtitleone': "3D model files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Audio Clips (.mp3, .wav)", 'subtitleone': "Sound files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Animations (.anim)", 'subtitleone': "Animation files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Animations Controllers (.controller)", 'subtitleone': "Controller files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Shaders (.shader)", 'subtitleone': "Shader files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Sprites (.png)", 'subtitleone': "Image files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Fonts (.ttf, .otf)", 'subtitleone': "TrueType or OpenType font files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Scriptable Objects (.asset)", 'subtitleone': "Custom asset files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Particle Systems (.prefab)", 'subtitleone': "Prefabs", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Packages (.unitypackage)", 'subtitleone': "Unity package files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Folders and Meta Files (.meta)", 'subtitleone': "Meta files", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Loading the Next Scene", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Loading a Selected Scene", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "General Loading", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                ]
            ...
            setTimeout(() => {
                const tSaving = [
                    {'title': "Saving the Game", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Reloading a Saved Game Where You Left Off", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                    {'title': "Managing Multiple Save Files Without Interference", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                ]
            ...
            setTimeout(() => {
                const tCompleteGame = [
                    {'title': "Build Settings", 'subtitleone': "Assets Tab", 'describeone': "Click Assets Tab(Top)", 'subtitletwo': "Go to Import New Asset", 'describetwo': "Search and Select in folder,", 'describethree': "Find in Projects Tab in Assets Folder<br><br>", 'image': "/images/ImportAssetFull.gif"},
                ]
...
function createInformationRightTwo() {
    ...
    function switchRightInformation(event) {
        if (event.target.id === 'game-object') {          //Keywords
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Transform", 'subtitleone': "Transform", 'describeone': "Transform represents the position, rotation, and scale of a GameObject in Unity.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>// Example 1: Accessing the position of a GameObject<br>Vector3 position = transform.position;<br>&nbsp<br>// Example 2: Rotating a GameObject<br>transform.Rotate(Vector3.up * Time.deltaTime);<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Mono Behaviour", 'subtitleone': "Mono Behaviour", 'describeone': "MonoBehaviour is the base class for Unity scripts that allow interaction with GameObjects.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>// Example 1: Creating a custom script<br>public class MyScript : MonoBehaviour { }<br>&nbsp<br>// Example 2: Implementing Start method in a script<br>void Start() { /* Initialization code */ }<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "start", 'subtitleone': "start", 'describeone': "Start is a Unity event method called once when a GameObject is enabled and the script starts.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>// Example 1: Initialization code in Start method<br>void Start() { /* Initialization code */ }<br>&nbsp<br>// Example 2: Starting a coroutine in Start method<br>void Start() { StartCoroutine(MyCoroutine()); }<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Destroy", 'subtitleone': "Destroy", 'describeone': "Destroy removes game objects or components from the scene during runtime, enabling object cleanup and management.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>// Example 1: Destroy an object after a delay<br>Destroy(gameObject, 3); // Destroy the current game object after 3 seconds<br>&nbsp<br>// Example 2: Destroy all game objects with a specific tag<br>GameObject[] enemies = GameObject.FindGameObjectsWithTag('Enemy');<br>foreach (GameObject enemy in enemies)<br>{<br>&nbsp&nbsp&nbsp&nbspDestroy(enemy);<br>}<br><br>", 'image': ""}, 
                    {'title': "Destroy Collide", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Set Active", 'subtitleone': "Set Active", 'describeone': "SetActive toggles the active state of game objects, controlling their visibility and behavior in the scene.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>// Example 1: Activate or deactivate a game object based on a condition<br>gameObject.SetActive(true); // Activate the current game object<br>gameObject.SetActive(false); // Deactivate the current game object<br>&nbsp<br>// Example 2: Toggle the active state of a UI panel<br>public GameObject panel;<br>panel.SetActive(!panel.activeSelf); // Toggle the active state of the panel<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Get Components", 'subtitleone': "Get Components", 'describeone': "GetComponent retrieves a component attached to a game object, allowing access to its properties and methods.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>// Example 1: Access the Rigidbody component of a game object<br>Rigidbody rb = gameObject.GetComponent<Rigidbody>();<br>&nbsp<br>// Example 2: Enable or disable a script component based on a condition<br>MyScript scriptComponent = gameObject.GetComponent<MyScript>();<br>scriptComponent.enabled = true; // Enable the script component<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Adding Components to GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Const", 'subtitleone': "const", 'describeone': "used to declare constants, whose values cannot be changed once initialized.", 'subtitletwo': "Code Explained", 'describetwo': "These variables are assigned the keyoword const and a data type<br><br>A const to make sure the values can not be changed anytime<br><br>Use when needed", 'describethree': "", 'classbackground': "code-background", 'code': "<br>const float Gravity = 9.81f; // Declaring a constant gravity with a value of 9.81<br><br>const string GameTitle = 'My Game'; // Declaring a constant string for the game title<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Public Variables", 'subtitleone': "Public Variables", 'describeone': "Public variables can be accessed and modified from other scripts.", 'subtitletwo': "Code Explained", 'describetwo': "<br>These variables can be accessed from other scripts in your game and seen in your component inside the editor", 'describethree': "", 'classbackground': "code-background", 'code': "<br>public int health = 100;<br><br>public GameObject playerObject;<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Static Variable", 'subtitleone': "Static Variable", 'describeone': "Static variables are associated with the class itself, not with individual instances of the class.<br><br>This means that all instances of the class share the same static variable. ", 'subtitletwo': "Shared Across Instances:", 'describetwo': "Since static variables are associated with the class, their values are shared across all instances of the class.<br><br>If one instance modifies the static variable, the change is visible to all other instances.", 'describethree': "<br><b>Accessed Through the Class Name:</b><br>Static variables are accessed using the class name, rather than through an instance of the class. This is because they don't belong to any particular instance.", 'classbackground': "code-background", 'code': "<br>public class ExampleClass<br>{<br>&nbsp&nbsp&nbsp&nbsppublic static int instanceCount = 0;<br>&nbsp&nbsp&nbsp&nbsp<br>&nbsp&nbsp&nbsp&nbsppublic ExampleClass()<br>&nbsp&nbsp&nbsp&nbsp{<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspinstanceCount++;<br>&nbsp&nbsp&nbsp&nbsp}<br>}<br><br>public class Program<br>{<br>&nbsp&nbsp&nbsp&nbsppublic static void Main(string[] args)<br>&nbsp&nbsp&nbsp&nbsp{<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspExampleClass obj1 = new &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspExampleClass();<br>&nbspConsole.WriteLine('Number of instances created: ' + ExampleClass.instanceCount);<br>&nbsp&nbsp&nbsp&nbsp}<br>}<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Method Declaration", 'subtitleone': "Method Declaration", 'describeone': "Method declaration defines the signature and implementation of a function.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>void MovePlayer() <br>{<br>&nbsp&nbsp&nbsp&nbsp// Implementation of moving the player<br>}<br><br>int CalculateSum(int a, int b) <br>{<br>&nbsp&nbsp&nbsp&nbspreturn a + b;<br>}<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Return Types", 'subtitleone': "Return Types", 'describeone': "Return types specify the type of value returned by the method.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>int CalculateSum(int a, int b) <br>{<br>&nbsp&nbsp&nbsp&nbspreturn a + b;<br>}<br><br>string GetPlayerName() <br>{<br>&nbsp&nbsp&nbsp&nbspreturn playerName;<br>}<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Overloading Methods", 'subtitleone': "Overloading Methods", 'describeone': "Overloading methods allow defining multiple methods with the same name but different parameters.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>void SpawnEnemy() <br>{<br>&nbsp&nbsp&nbsp&nbsp// Implementation for spawning an enemy without parameters<br>}<br><br>void SpawnEnemy(Vector3 position) <br>{<br>&nbsp&nbsp&nbsp&nbsp// Implementation for spawning an enemy at a specific position<br>}<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLevels = [
                    {'title': "Class Instance", 'subtitleone': "Objects", 'describeone': "refers to a specific occurrence of a class.", 'subtitletwo': "Car car1 = new Car();", 'describetwo': "Class object = key From Class", 'describethree': "<br><span class='subtitle'>car1.Model = 'Toyota'</span><br><br>Object.Feild = Argument;", 'classbackground': "code-background", 'code': "public class Car<br>{<br>&nbsp&nbsp&nbsp&nbsppublic string Model;<br>&nbsp&nbsp&nbsp&nbsppublic string Color;<br>&nbsp&nbsp&nbsp&nbsp<br>&nbsp&nbsp&nbsp&nbsppublic void Drive()<br>&nbsp&nbsp&nbsp&nbsp{<br>&nbsp&nbsp&nbsp&nbsp&nbspConsole.WriteLine('The ' + Color + ' ' + &nbsp&nbsp&nbsp&nbsp&nbspModel + ' is driving.');<br>&nbsp&nbsp&nbsp&nbsp}<br>}<br>Car car1 = new Car();<br>car1.Model = 'Toyota';<br>car1.Color = 'Blue';<br><br>Car car2 = new Car();<br>car2.Model = 'Ford';<br>car2.Color = 'Red';<br>", 'image': ""},
            ...
            setTimeout(() => {
                const tLevels = [
                    {'title': "Class Constructor", 'subtitleone': "Class Constructor", 'describeone': "Constructor initializes objects of a class.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>public Player()<br>{<br>&nbsp&nbsp&nbsp&nbsp// Constructor for Player class<br>}<br>&nbsp<br>public Enemy(float health)<br>{<br>&nbsp&nbsp&nbsp&nbsp// Constructor for Enemy class with parameter<br>}<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Properties", 'subtitleone': "Properties", 'describeone': "Properties define the attributes of objects.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "-<br>", 'classbackground': "code-background", 'code': "<br>public class Player<br>{<br>&nbsp&nbsp&nbsp&nbsppublic int Health { get; set; } // Health property<br>}<br><br>public class Enemy<br>{<br>&nbsp&nbsp&nbsp&nbsppublic string Name { get; set; } // Name property<br>}<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Methods", 'subtitleone': "Methods", 'describeone': "Methods define behavior or actions of objects.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "-<br>", 'classbackground': "code-background", 'code': "<br>public class Player<br>{<br>&nbsp&nbsp&nbsp&nbsppublic void Move() { /* Move logic / } // Move method<br>}<br><br>public class Enemy<br>{<br>&nbsp&nbsp&nbsp&nbsppublic void Attack() { / Attack logic */ } // Attack method<br>}<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Awake()", 'subtitleone': "Awake()", 'describeone': "The Awake method is called when a script instance is being loaded. It's used for initializing variables or setting up references.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>void Awake()<br>{<br>&nbsp&nbsp&nbsp&nbspplayer = GameObject.FindWithTag('Player');<br>}<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Start()", 'subtitleone': "Start()", 'describeone': "The Start method is called before the first frame update. It's often used for initialization tasks that require all objects to be set up.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "void Start()<br>{<br>&nbsp&nbsp&nbsp&nbsprb = GetComponent<Rigidbody>();<br>}<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "OnDestroy()", 'subtitleone': "OnDestroy()", 'describeone': "The OnDestroy method is called when the object is being destroyed. It's used for releasing resources or performing cleanup tasks.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>void OnDestroy()<br>{<br>&nbsp&nbsp&nbsp&nbspDestroy(gameObject);<br>}<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "OnGUI()", 'subtitleone': "OnGUI()", 'describeone': "The OnGUI method is called multiple times per frame to render and handle GUI events.", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>void OnGUI()<br>{<br>&nbsp&nbsp&nbsp&nbspGUI.Label(new Rect(10, 10, 100, 20), 'Hello, World!');<br>}<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
            ...
            setTimeout(() => {
                const tLoading = [
                    {'title': "Adding Components to GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>cube.AddComponent<MeshRenderer>();<br>cube.AddComponent<BoxCollider>();<br><br>", 'image': ""}, 
                    {'title': "Instantiating Prefabs", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br><br>", 'image': ""}, 
                    {'title': "Finding GameObjects in the Scene", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>GameObject cube = GameObject.Find('Cube');<br><br>", 'image': ""}, 
                    {'title': "Destroying GameObjects", 'subtitleone': "A GameObject is a fundamental object in Unity", 'describeone': "<br>", 'subtitletwo': "Code Explained", 'describetwo': "<br>", 'describethree': "", 'classbackground': "code-background", 'code': "<br>Destroy(cube);<br><br>", 'image': ""},
                ]
